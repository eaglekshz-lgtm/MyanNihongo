...
class LearningModeSelectionPage extends StatefulWidget {
  ...
  @override
  State<LearningModeSelectionPage> createState() =>
      _LearningModeSelectionPageState();
}
...
class _LearningModeSelectionPageState extends State<LearningModeSelectionPage> {
  ...
  void didChangeDependencies() {
    ...
    if (!_argsExtracted) {
      final args =
          ModalRoute.of(context)!.settings.arguments as LearningModeConfigArgs?;
      if (args != null) {
        _level = args.level;
...
class _LearningModeList extends StatelessWidget {
  ...
  const _LearningModeList({required this.level, required this.wordType});
  ...
  void _navigateToConfigPage(BuildContext context) {
    ...
    Navigator.pushNamed(
      ...
      arguments: LearningModeConfigArgs(level: level, wordType: wordType),
    );
  }
    ...
    return ListView(
      children: [
        LearningModeCard(
          ...
          title: 'Recall Mode',
          description:
              'Test your memory! See Japanese word first, flip to recall Burmese meaning and reading.',
          color: Theme.of(context).colorScheme.primary,
          features: const ['Quiz yourself', 'Active recall', 'Memory testing'],
        ...
        LearningModeCard(
          ...
          title: 'Absorb Mode',
          description:
              'Absorb knowledge comprehensively! See all content together, flip for examples and usage.',
